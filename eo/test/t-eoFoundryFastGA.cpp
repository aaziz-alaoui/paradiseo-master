...
eoAlgoFoundryFastGA<Bits>& make_foundry(eoFunctorStore& store, eoInit<Bits>& init, eoPopEvalFunc<Bits>& eval_onemax, int dimension, int pop_size)
{

    auto& foundry = store.pack< eoAlgoFoundryFastGA<Bits> >(init, eval_onemax);
