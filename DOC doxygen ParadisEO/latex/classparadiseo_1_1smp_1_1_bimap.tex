\hypertarget{classparadiseo_1_1smp_1_1_bimap}{}\doxysection{Référence du modèle de la classe paradiseo\+::smp\+::Bimap$<$ A, B $>$}
...
Check if the bimap is empty \begin{DoxyReturn}{Renvoie}
...
Return a map which represents the left association. \begin{DoxyReturn}{Renvoie}
left\+Association 
\end{DoxyReturn}
...
Return a map which represents the right association. \begin{DoxyReturn}{Renvoie}
right\+Association 
\end{DoxyReturn}
...
Return the number of associations. \begin{DoxyReturn}{Renvoie}
Size of bimap 
\end{DoxyReturn}
