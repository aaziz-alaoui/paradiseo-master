\hypertarget{classeo_linear_decreasing_weight_up}{}\doxysection{Référence du modèle de la classe eo\+Linear\+Decreasing\+Weight\+Up$<$ Weight\+Type, Stop\+Criteria\+Type $>$}
...
Graphe d\textquotesingle{}héritage de eo\+Linear\+Decreasing\+Weight\+Up$<$ Weight\+Type, Stop\+Criteria\+Type $>$\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
...
Graphe de collaboration de eo\+Linear\+Decreasing\+Weight\+Up$<$ Weight\+Type, Stop\+Criteria\+Type $>$\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
...
\mbox{\hyperlink{class_linear}{Linear}} (inertia) weight updater for particle swarm optimization. Update a weight according to\+: w(t)=(w(0)-\/w(\+Nt))$\ast$(Nt -\/t)/\+Nt + w(\+Nt) where t is the current generation/event Nt is the total number of generations/event w(0) is the initial weight w(\+Nt) is the last inertia weight 
...
Implémente \mbox{\hyperlink{classeo_u_f_a786e028409366dc273e19104f17ba68a}{eo\+U\+F$<$ Weight\+Type \&, void $>$}}.
