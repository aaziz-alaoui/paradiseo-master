\hypertarget{classmo_first_impr_h_c}{}\doxysection{Référence du modèle de la classe mo\+First\+Impr\+HC$<$ Neighbor $>$}
...
Graphe d\textquotesingle{}héritage de mo\+First\+Impr\+HC$<$ Neighbor $>$\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
...
Graphe de collaboration de mo\+First\+Impr\+HC$<$ Neighbor $>$\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
