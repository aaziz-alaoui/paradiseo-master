\hypertarget{class_b_b_royal_road_eval}{}\doxysection{Référence du modèle de la classe B\+B\+Royal\+Road\+Eval$<$ E\+OT $>$}
...
Graphe d\textquotesingle{}héritage de B\+B\+Royal\+Road\+Eval$<$ E\+OT $>$\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
...
Graphe de collaboration de B\+B\+Royal\+Road\+Eval$<$ E\+OT $>$\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
...
get the targets \begin{DoxyReturn}{Renvoie}
...
get the number of blocks \begin{DoxyReturn}{Renvoie}
