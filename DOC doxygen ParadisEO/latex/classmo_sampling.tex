\hypertarget{classmo_sampling}{}\doxysection{Référence du modèle de la classe mo\+Sampling$<$ Neighbor $>$}
...
Graphe d\textquotesingle{}héritage de mo\+Sampling$<$ Neighbor $>$\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
...
Graphe de collaboration de mo\+Sampling$<$ Neighbor $>$\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
