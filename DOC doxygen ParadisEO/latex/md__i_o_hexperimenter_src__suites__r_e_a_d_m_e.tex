...
\item {\itshape add\+C\+S\+V\+Logger(logger)}, assigns a {\bfseries{\mbox{\hyperlink{class_i_o_hprofiler__csv__logger}{I\+O\+Hprofiler\+\_\+csv\+\_\+logger}}}} class to the suite.
\item {\itshape I\+O\+Hprofiler\+\_\+set\+\_\+suite\+\_\+problem\+\_\+id(problem\+\_\+id)}
\item {\itshape I\+O\+Hprofiler\+\_\+set\+\_\+suite\+\_\+instance\+\_\+id(instance\+\_\+id)}
\item {\itshape I\+O\+Hprofiler\+\_\+set\+\_\+suite\+\_\+dimension(dimension)}
\item {\itshape map\+I\+D\+T\+O\+Name}, is to match problem id and name.
\end{DoxyItemize}\hypertarget{md__i_o_hexperimenter_src__suites__r_e_a_d_m_e_autotoc_md92}{}\doxysubsection{Creating a suite}\label{md__i_o_hexperimenter_src__suites__r_e_a_d_m_e_autotoc_md92}
{\bfseries{I\+O\+Hexperimenter}} provides a {\bfseries{\mbox{\hyperlink{class_p_b_o__suite}{P\+B\+O\+\_\+suite}}}} for pseudo Boolean problems, but it is also easy to add your own suite. Creating a suite is done by registering problems in the suite and assigning ids to them.
...
\DoxyCodeLine{\mbox{\hyperlink{classregister_in_factory}{registerInFactory<IOHprofiler\_problem<int>}},\mbox{\hyperlink{class_ising__1_d}{Ising\_1D}}> regIsing\_1D(\textcolor{stringliteral}{"Ising\_1D"});}
\DoxyCodeLine{\mbox{\hyperlink{classregister_in_factory}{registerInFactory<IOHprofiler\_problem<int>}},\mbox{\hyperlink{class_ising__2_d}{Ising\_2D}}> regIsing\_2D(\textcolor{stringliteral}{"Ising\_2D"});}
\DoxyCodeLine{\mbox{\hyperlink{classregister_in_factory}{registerInFactory<IOHprofiler\_problem<int>}},\mbox{\hyperlink{class_ising___triangle}{Ising\_Triangle}}> regIsing\_Triangle(\textcolor{stringliteral}{"Ising\_Triangle"});}
\DoxyCodeLine{}
