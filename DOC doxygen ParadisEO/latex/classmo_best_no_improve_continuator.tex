\hypertarget{classmo_best_no_improve_continuator}{}\doxysection{Référence du modèle de la classe mo\+Best\+No\+Improve\+Continuator$<$ Neighbor $>$}
...
Graphe d\textquotesingle{}héritage de mo\+Best\+No\+Improve\+Continuator$<$ Neighbor $>$\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
...
Graphe de collaboration de mo\+Best\+No\+Improve\+Continuator$<$ Neighbor $>$\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
...
the current number of iteration without improvement \begin{DoxyReturn}{Renvoie}
