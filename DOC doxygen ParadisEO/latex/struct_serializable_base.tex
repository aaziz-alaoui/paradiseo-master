\hypertarget{struct_serializable_base}{}\doxysection{Référence du modèle de la structure Serializable\+Base$<$ T $>$}
\label{struct_serializable_base}\index{SerializableBase$<$ T $>$@{SerializableBase$<$ T $>$}}


Graphe d\textquotesingle{}héritage de Serializable\+Base$<$ T $>$\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
...
Graphe de collaboration de Serializable\+Base$<$ T $>$\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
